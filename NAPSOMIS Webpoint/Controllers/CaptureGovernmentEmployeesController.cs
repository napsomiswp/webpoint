...
namespace NAPSOMIS_Webpoint.Controllers
    {
    public class CaptureGovernmentEmployeesController : Controller
        {
        ...
        public ActionResult Form()
            ...
            if (TempData.Peek("MyGovOccupations") == null)
                {
                TempData["MyGovOccupations"] = GetMyGovOccupations();
                }
        ...
        public ActionResult StartForm(CaptureMemRegViewModel memb)
            {
        ...
        [HttpPost]
        public ActionResult Form(CaptureMemRegViewModel c)
            {
            try
                {

                TempData["GovernmentForm"] = c;
                TempData["GovernmentReferenceNo"] = c.fref_no;
        ...
        public ActionResult CaptureDependants()
            ...
            try
                {
                if (TempData.Peek("GovernmentReferenceNo") != null)
                    {
                    nom_tr ntp = new nom_tr();
                    ntp.fref_no = TempData.Peek("GovernmentReferenceNo").ToString();
        ...
        public ActionResult CompleteCapture(nom_tr dependants)
            ...
            if (alldependants == null)
                {
                ViewBag.Message = "Please add atlease one dependant before proceeding";
                return View("DependantCapture", dependants);
                }
            ...
            CaptureMemRegViewModel c = (CaptureMemRegViewModel)TempData.Peek("GovernmentForm");
            ...
            return View("Form", new CaptureMemRegViewModel());
        ...
        public List<PDCTemplate> GetMyGovOccupations()
            {
            DataTable mytable = new DataTable();
        ...
        #region "EDIT GOVERNMENT EMPLOYEES"
        ...
        public ActionResult EditForm(CaptureMemRegViewModel memb)
            ...
            try
                ...
                if (refno != null)
                    ...
                    //mvm.freg_date = mt[0].freg;
                    mvm.fsex = mt[0].fsex;

                    mvm.fssno = mt[0].fssno;
                    mvm.fstaffno = mt[0].fstaffno;
                    //mvm.fstatus = mt[0].fstatus;
        ...
        public ActionResult EditFormtoDependants(CaptureMemRegViewModel c)
            ...
            try
                ...
                TempData["GovernmentEditReferenceNo"] = c.fref_no;
        ...
        public ActionResult DeleteDependants(int id)
            ...
            try
                ...
                if (TempData.Peek("GovernmentEditReferenceNo") != null)
                    {
                    nom_tr ntp = new nom_tr();
                    ntp.fref_no = TempData.Peek("GovernmentEditReferenceNo").ToString();
        ...
        public ActionResult SaveFormEdit(CaptureMemRegViewModel c)
            ...
            //entry.Property(e => e.fref_no).IsModified = false;
