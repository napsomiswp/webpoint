namespace NAPSOMIS_Webpoint.Models
{
    ...
    [Table("BeneficiaryApplicationTransactionTemp")]
    public partial class BeneficiaryApplicationTransactionTemp
    {
        [StringLength(3)]
        ...
        [StringLength(17)]
        public string fold_batch_no { get; set; }

        [StringLength(17)]
        public string fssno { get; set; }

        [StringLength(12)]
        public string fold_claim_no { get; set; }
