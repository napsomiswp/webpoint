...
namespace NAPSOMIS_Webpoint.ViewModels
    ...
    public partial class MemberCheckListViewModel
        {
        ...
        [StringLength(60)]
        [Display(Name = "Permanent Address")]
        public string fper_addr_dependant { get; set; }

        [StringLength(60)]
        [Display(Name = "Residential Address")]
        public string fres_addr_dependant { get; set; }

        public int ID_SBTS_DEPENDANT { get; set; }
